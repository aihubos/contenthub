...
if(!['https://github.com/aihubos/contenthub.git','https://github.com/aihubos/contenthub','git@github.com:aihubos/contenthub.git'].includes(remote))throw new Error('Unexpected remote');
